...
const CreateTestimonials = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      if(res.status === 201) router.push(`/admin/feedbacks/${res.data.feedback_id}`);
    },
    validationSchema: FeedbackSchemaCreate
  });
  return <ContentPageContainer>
    <form onSubmit={formik.handleSubmit} ref={formRef}>
      <Typography variant={'h4'} mb={3}>Create a new Feedback</Typography>
      <ContentPageFlexBox
      >
        <Stack
          direction={'column'}
        ...
        >
          {lang == 'EN' &&
            <TextField
              label={'English Name'} fullWidth
              name={'name_en'}
              error={formik.touched.name_en && formik.errors.name_en ? true : false}
              helperText={formik.touched.name_en && formik.errors.name_en ? formik.errors.name_en : ''}
          ...
          {lang == 'AR' &&
            <TextField
              label={'Arabic Name'} fullWidth
              name={'name_ar'}
              error={formik.touched.name_ar && formik.errors.name_ar ? true : false}
              helperText={formik.touched.name_ar && formik.errors.name_ar ? formik.errors.name_ar : ''}
              onChange={formik.handleChange}
          ...
          {lang == 'EN' && <TextField
            ...
            fullWidth
            name={'position_en'}
            error={formik.touched.position_en && formik.errors.position_en ? true : false}
            helperText={formik.touched.position_en && formik.errors.position_en ? formik.errors.position_en : ''}
            onChange={formik.handleChange}
          ...
          {lang == 'AR' &&
            <TextField
              ...
              fullWidth
              name={'position_ar'}
              error={formik.touched.position_ar && formik.errors.position_ar ? true : false}
              helperText={formik.touched.position_ar && formik.errors.position_ar ? formik.errors.position_ar : ''}
              onChange={formik.handleChange}
          ...
          {lang == 'EN' &&
            <TextField
              ...
              rows={10}
              name={'feedback_en'}
              error={formik.touched.feedback_en && formik.errors.feedback_en ? true : false}
              helperText={formik.touched.feedback_en && formik.errors.feedback_en ? formik.errors.feedback_en : ''}
              onChange={formik.handleChange}
          ...
          {lang == 'AR' &&
            <TextField
              ...
              rows={10}
              name={'feedback_ar'}
              error={formik.touched.feedback_ar && formik.errors.feedback_ar ? true : false}
              helperText={formik.touched.feedback_ar && formik.errors.feedback_ar ? formik.errors.feedback_ar : ''}
              onChange={formik.handleChange}
          ...
          <label htmlFor="contained-button-file">
            ...
            <Button variant="contained"
              component={'span'}>
              {formik.errors.client_photo && <span>{formik.errors.client_photo}</span> ||
