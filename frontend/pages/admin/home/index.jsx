...
const HomePage = ({ home,globalData }) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      description: {
        en: home?.description?.en || "",
        ar: home?.description?.ar || "",
      },
      keywords: home?.keywords?.en,
      sentence_title: {
        en: home?.sentence_title?.en || "",
        ar: home?.sentence_title?.ar || "",
      },
      sentence_subtitle: {
        en: home?.sentence_subtitle?.en || "",
        ar: home?.sentence_subtitle?.ar || "",
      },
      sentence_description: {
        en: home?.sentence_description?.en || "",
        ar: home?.sentence_description?.ar || "",
      },
    },
              ...
              {lang == "EN" ? (
                <>
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      formik.setFieldValue("description", {
                        en: e.target.value,
                        ar: formik.values.description?.ar,
                      })
                    }
                    onBlur={formik.handleBlur}
                    variant="outlined"
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      formik.setFieldValue("sentence_title", {
                        en: e.target.value,
                        ar: formik.values.sentence_title?.ar,
                      })
                    }
                    onBlur={formik.handleBlur}
                    variant="outlined"
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      formik.setFieldValue("sentence_subtitle", {
                        en: e.target.value,
                        ar: formik.values.sentence_subtitle?.ar,
                      })
                    }
                    onBlur={formik.handleBlur}
                    variant="outlined"
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      formik.setFieldValue("sentence_description", {
                        en: e.target.value,
                        ar: formik.values.sentence_description?.ar,
                      })
                    }
                    onBlur={formik.handleBlur}
                    variant="outlined"
                ...
                <>
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      formik.setFieldValue("description", {
                        en: formik.values.description?.en,
                        ar: e.target.value,
                      })
                    }
                    onBlur={formik.handleBlur}
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      formik.setFieldValue("sentence_title", {
                        en: formik.values.sentence_title?.en,
                        ar: e.target.value,
                      })
                    }
                    onBlur={formik.handleBlur}
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      formik.setFieldValue("sentence_subtitle", {
                        en: formik.values.sentence_subtitle?.en,
                        ar: e.target.value,
                      })
                    }
                    onBlur={formik.handleBlur}
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      formik.setFieldValue("sentence_description", {
                        en: formik.values.sentence_description?.en,
                        ar: e.target.value,
                      })
                    }
                    onBlur={formik.handleBlur}
