import { Box, Button, FormControl, Input, InputLabel, MenuItem, Select, Stack, TextField, Typography } from "@mui/material";
import {
...
const CreateSection = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async values => {
      ...
      console.log(res);
      if (res.status === 201) router.push(`/admin/projects/${router.query.project_id}/sections/${res.data.section_id}`);
    },
    validationSchema: ProjectSectionSchemaCreate
  })
  return <ContentPageContainer>
    <Typography variant={'h4'} mb={3}>Create a new Section</Typography>
    <ContentPageFlexBox>
      <Stack
        direction={'column'}
        height={'100%'}
          ...
          <Stack
            ...
            {lang !== "AR" ?
              <>
                ...
                <TextField
                  ...
                  helperText={formik.touched.subtitle_en && formik.errors.subtitle_en}
                  name={'subtitle_en'}
                ...
                <TextField
                  ...
                  helperText={formik.touched.subtitle_ar && formik.errors.subtitle_ar}
                  name={'subtitle_ar'}
            ...
            <label htmlFor="contained-button-file">
              <Input
                ...
                sx={{ display: "none" }}
                name="section_photo"
                onChange={(e) => formik.setFieldValue("section_photo", e.target.files[0])}
