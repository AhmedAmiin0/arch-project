...
import { ContentPageContainer, ContentPageFlexBox } from "../../../../../components/dashboard/layout/ContentPage/ContentPageContainer";
import DoneIcon from '@mui/icons-material/Done';
import DeleteIcon from '@mui/icons-material/Delete';
import { useCreate, useDelete } from "../../../../../hooks/useCRUD";
import axios from "../../../../../config/axios";
import { ProjectSectionSchemaEdit } from "../../../../../components/dashboard/schemas/ProjectSectionSchema";
const EditSection = ({ section }) => {
  ...
  const { createItem } = useCreate(locale, `projects/${project_id}/sections/${section_id}`);
  ...
  const formik = useFormik({
    ...
    onSubmit: async values => {
      ...
      if (values.section_photo && typeof values.section_photo === 'object' && values.section_photo.size > 0) {
  ...
  return <ContentPageContainer>
    <form onSubmit={formik.handleSubmit} ref={formRef}>
      <Typography variant={'h4'} mb={3}>Edit Section</Typography>
      <ContentPageFlexBox>
        ...
        <Box flex={3} display={'flex'} flexDirection={'column'} justifyContent={'center'} alignItems={'center'}>
          ...
          <label htmlFor="contained-button-file" style={{
            ...
            />
            <img
              src={formik.values.section_photo.src || URL.createObjectURL(formik.values.section_photo)}
