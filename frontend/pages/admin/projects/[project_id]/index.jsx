...
const EditProject = ({
  ...
  const formik = useFormik({
    initialValues: {
      ...
      project_highlights_section1_title: project?.project_highlights_section1_title,
      project_highlights_section1_description: project?.project_highlights_section1_description,
      project_highlights_section2_title: project?.project_highlights_section2_title,
      project_highlights_section2_description: project?.project_highlights_section2_description,
      project_highlights_section3_title: project?.project_highlights_section3_title,
      project_highlights_section3_description: project?.project_highlights_section3_description,
      project_highlights_section4_title: project?.project_highlights_section4_title,
      project_highlights_section4_description: project?.project_highlights_section4_description,
    ...
    onSubmit: async (values) => {
      ...
      formData.append("project_highlights_section1_title", values.project_highlights_section1_title);
      formData.append("project_highlights_section1_description", values.project_highlights_section1_description);
      formData.append("project_highlights_section2_title", values.project_highlights_section2_title);
      formData.append("project_highlights_section2_description", values.project_highlights_section2_description);
      formData.append("project_highlights_section3_title", values.project_highlights_section3_title);
      formData.append("project_highlights_section3_description", values.project_highlights_section3_description);
      formData.append("project_highlights_section4_title", values.project_highlights_section4_title);
      formData.append("project_highlights_section4_description", values.project_highlights_section4_description);
      if (values.project_thumb && typeof values.project_thumb === 'object' && values.project_thumb.size > 0) {
          ...
          >
            ...
            <label htmlFor="contained-button-file" style={{
              ...
              <Input accept="image/*" id="contained-button-file" type="file" sx={{ display: 'none', }}
                name={'project_thumb'}
                onChange={(e) => formik.setFieldValue('project_thumb', e.target.files[0])}
              />
              <img
                src={formik.values.project_thumb.src || URL.createObjectURL(formik.values.project_thumb)}
            ...
            <Box>
              ...
              <HighlightedSectionStyles>
                <TextField
                  ...
                  {...formik.getFieldProps("project_highlights_section1_title")}
                  error={
                ...
                <TextField
                  ...
                  error={formik.touched.project_highlights_section1_description && formik.errors.project_highlights_section1_description ? true : false}
                  helperText={formik.touched.project_highlights_section1_description && formik.errors.project_highlights_section1_description ? formik.errors.project_highlights_section1_description : ""}
                />
              </HighlightedSectionStyles>
            </Box>
            <Box>
