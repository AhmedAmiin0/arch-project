...
const CorporateSentence = ({sentence}) => {
  ...
  return <ContentPageContainer>
    <form onSubmit={formik.handleSubmit} ref={formRef}>
      <Typography variant={'h4'} mb={3}>Corporate sentence</Typography>
      <ContentPageFlexBox
      >
        <Stack
          direction={'column'}
...
CorporateSentence.layout = 'L3'
export default CorporateSentence;
export async function getStaticProps() {
  const sentence = await axios.get('corporate_section').then(res => res.data) ?? {};
  return {
    props: {
      sentence
    },
