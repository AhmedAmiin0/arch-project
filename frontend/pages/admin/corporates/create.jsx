...
const CreateCorporate = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      if (res.status === 201) router.push(`/admin/corporates/${res.data.corporate_id}`);
      console.log(res);
    },
  ...
  return <ContentPageContainer>
    <form onSubmit={formik.handleSubmit} ref={formRef}>
      <Typography variant={'h4'} mb={3}>Create a new Corporate</Typography>
      <ContentPageFlexBox
      >
        <Stack
          direction={'column'}
        ...
        >
          ...
          <label htmlFor="contained-button-file">
            ...
            <Button variant="contained"
              component={'span'}>
              {formik.errors.corporate_logo && <span>{formik.errors.corporate_logo}</span> ||
